...
class LoginScreen extends Component {
    ...
    render(){
        return(
            <View style={{flex: 1}}>
                <ImageBackground source={require("../assets/iamges/login_bg.jpg")} style={{flex: 1}}>
                    ...
                    <View>
                        <View style={{height:150, backgroundColor:'white'}}>
                            <View style={{opacity:1, alignItems:'flex-start', paddingHorizontal:25, marginTop:25}}><Text style={{fontSize:24}}>Get Moving</Text></View>
                            <TouchableOpacity>
                                <View style={{marginTop:25, paddingHorizontal:25, flexDirection:'row'}}>
                                    <Image source={require('../assets/iamges/flag.png')} style={{height: 24, width: 24, resizeMode:'contain'}}/>
